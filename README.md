...
<html lang="en" style="overflow: hidden;touch-action: manipulation;user-scalable: none;-ms-content-zooming: none;-ms-touch-action: manipulation;">
    ...
    <body class="bg-white text-black dark:text-white dark:bg-slate-800">
        ...
        <header class="text-black bg-slate-300 h-28 dark:text-white dark:bg-slate-700">
            ...
            <p class="text-center">
                <input type="text" id="text_input" class="text-black rounded-l-md h-8 w-20"><button type="button" id="add_Todo" class="bg-sky-500 text-white rounded-r-md h-8" py-onClick="App.addTodo()">Add todo</button>
                <button type="button" py-onClick="App.delTodo()" class="bg-red-500 text-white rounded-l-md ml-7 h-8">Delete Todo</button><input class="w-10 rounded-r-md text-black h8" id="del_index" type="number">
            </p>
        </header>
        <div id="todo_out"></div>
